...
@Table(name = "experienciaProfissional") // Especifica o nome da tabela no banco de dados que esta entidade irá mapear.
@Getter
@Setter
@NoArgsConstructor
@AllArgsConstructor
...
public class ExperienciaProfissional {
    ...
    @Column(nullable = false, length=100) // Especifica que a coluna "nome" é obrigatória e única (sem repetições)
    @ToString.Include
